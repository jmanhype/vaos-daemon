defmodule Daemon.Channels.HTTP.API.CommandCenterRoutes do
  @moduledoc """
  ...
  get "/patterns" do
    patterns =
      Daemon.Agent.Orchestrator.Patterns.list_patterns()
