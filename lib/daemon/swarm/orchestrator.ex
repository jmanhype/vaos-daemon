defmodule Daemon.Swarm.Orchestrator do
  @moduledoc """
  ...
  alias Daemon.Swarm.{Worker, Mailbox, Planner, Patterns}
  alias Daemon.Providers.Registry, as: Providers
  ...
  defp terminate_workers(workers) do
    Enum.each(workers, fn {_spec, pid} ->
      if is_pid(pid) and Process.alive?(pid) do
        DynamicSupervisor.terminate_child(Daemon.Swarm.AgentPool, pid)
      end
    end)
  end
