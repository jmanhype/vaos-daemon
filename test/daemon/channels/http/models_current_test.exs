defmodule Daemon.Channels.HTTP.API.ModelsCurrentTest do
  @moduledoc """
  ...
  setup do
    ...
    on_exit(fn ->
      ...
      if is_nil(original_model) do
        ...
        Application.put_env(:daemon, :default_model, original_model)
      end
  ...
  describe "GET /current" do
    ...
    test "reflects Application env default_provider" do
      ...
      Application.put_env(:daemon, :default_model, "llama3.2:latest")
  ...
  describe "POST /current with ollama provider" do
    ...
    test "updates Application env default_provider" do
      ...
      assert Application.get_env(:daemon, :default_provider) == :ollama
    end

    test "updates Application env default_model" do
      json_post("/current", %{"provider" => "ollama", "model" => "llama3.2:latest"})
      assert Application.get_env(:daemon, :default_model) == "llama3.2:latest"
    end
