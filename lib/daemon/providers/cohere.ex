defmodule Daemon.Providers.Cohere do
  @moduledoc """
  ...
  def chat(messages, opts \\ []) do
    api_key = Application.get_env(:daemon, :cohere_api_key)

    model =
      Keyword.get(opts, :model) ||
        Application.get_env(:daemon, :cohere_model, default_model())

    base_url = Application.get_env(:daemon, :cohere_url, @default_url)
