defmodule Daemon.Python.Sidecar do
  @moduledoc """
  ...
  def init(_opts) do
    state = %{
      ...
      pending_calls: [],
      python_path: Application.get_env(:daemon, :python_path, "python3")
    }
  ...
  defp sidecar_script_path do
    Path.join([:code.priv_dir(:daemon) |> to_string(), "python", "sidecar.py"])
  end
