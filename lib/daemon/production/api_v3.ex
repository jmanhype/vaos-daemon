defmodule Daemon.Production.APIV3 do
  @moduledoc "HTTP routes for Film Production pipeline v3 (multi-ingredient)."
  use Plug.Router
  ...
  get "/status" do
    status = Daemon.Production.FilmPipelineV3.status()
