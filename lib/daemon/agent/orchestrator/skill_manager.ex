defmodule Daemon.Agent.Orchestrator.SkillManager do
  @moduledoc """
  Dynamic skill creation and discovery for the orchestrator.

  Skills are SKILL.md files persisted to `~/.daemon/skills/<name>/`.
  """
  require Logger
  ...
  @doc """
  Create a new skill file at `~/.daemon/skills/<name>/SKILL.md`.
