defmodule Daemon.Events.Bus do
  ...
  @event_types ~w(user_message llm_request llm_response tool_call tool_result agent_response system_event channel_connected channel_disconnected channel_error ask_user_question survey_answered algedonic_alert signal_classified investigation_complete architectural_finding work_dispatched work_dispatch_complete decision_proposed decision_completed)a
