defmodule OptimalSystemAgent.VasSwarm.IntegrationTest do
  ...
  alias OptimalSystemAgent.VasSwarm.Integration
  ...
  describe "Integration" do
    setup do
      ...
      Application.put_env(:optimal_system_agent, :vas_swarm_enabled, true)
      :ok
    end
