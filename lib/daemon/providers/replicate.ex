defmodule Daemon.Providers.Replicate do
  @moduledoc """
  ...
  def chat(messages, opts \\ []) do
    api_key = Application.get_env(:daemon, :replicate_api_key)

    model =
      Keyword.get(opts, :model) ||
        Application.get_env(:daemon, :replicate_model, default_model())

    base_url = Application.get_env(:daemon, :replicate_url, @default_url)
