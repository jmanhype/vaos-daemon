defmodule Daemon.Tools.Builtins.UseSkill do
  @moduledoc """
  ...
  defp safe_path?(path) do
    ...
    skills_base = Path.expand("~/.daemon/skills")
    priv_base = Application.app_dir(:daemon, "priv/skills")
  ...
  defp run_with_llm(prompt, _skill) do
    ...
    llm_mod = Application.get_env(:daemon, :llm_module, nil)
