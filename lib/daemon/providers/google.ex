defmodule Daemon.Providers.Google do
  @moduledoc """
  ...
  def chat(messages, opts \\ []) do
    api_key = Application.get_env(:daemon, :google_api_key)

    model =
      Keyword.get(opts, :model) ||
        Application.get_env(:daemon, :google_model, default_model())

    base_url = Application.get_env(:daemon, :google_url, @default_url)
