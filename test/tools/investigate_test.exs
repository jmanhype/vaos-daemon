defmodule Daemon.Tools.Builtins.InvestigateTest do
  ...
  test "preferred_advocate_provider honors explicit override" do
    Application.put_env(:daemon, :default_provider, :zhipu)
    Application.put_env(:daemon, :investigate_advocate_provider, :openai)

    assert Investigate.preferred_advocate_provider() == :openai
  end

  test "preferred_advocate_model honors explicit model override" do
    Application.put_env(:daemon, :default_provider, :zhipu)
    Application.put_env(:daemon, :investigate_advocate_provider, :openai)
    Application.put_env(:daemon, :investigate_advocate_model, "gpt-4o-mini")
  ...
  test "evidence_store_for keeps observational public-debate fragments in belief" do
    ...
    evidence = %{
      ...
      paper_type: :review,
      summary:
        "The Cochrane review of MMR vaccines acknowledges that \"public debate over the safety of the trivalent MMR vaccine and the resultant drop in vaccination coverage in several countries persists,\" [Paper 1]."
    }

    paper = %{
      "title" => "Vaccines for measles, mumps and rubella in children",
      "abstract" =>
        "This Cochrane review documents vaccine safety while noting that public debate over the safety of the trivalent MMR vaccine persists.",
  ...
  test "evidence_store_for keeps historical observational fragments in belief" do
    context = %{
      normalized_topic: "vaccines cause autism",
      evidence_profile: %{
        kind: :observational,
    ...
    evidence = %{
      ...
      paper_type: :study,
      summary:
        "The original 1998 case series published in the Lancet by Wakefield and colleagues \"suggested that the measles, mumps, and rubella (MMR) vaccine may predispose to behavioral regression and pervasive developmental disorder in children\" [Paper 4]. However, this study was later completely retracted after investigations found ethical violations and scientific misrepresentation."
    }

    paper = %{
      "title" => "The MMR vaccine and autism: Sensation, refutation, retraction, and fraud",
      "abstract" =>
        "The original 1998 case series suggested a link but was later completely retracted after findings of ethical violations and scientific misrepresentation.",
      "publicationTypes" => []
    }
  ...
  test "evidence_store_for keeps retraction-history fragments in belief" do
    context = %{
      normalized_topic: "vaccines cause autism",
      evidence_profile: %{
        kind: :observational,
    ...
    evidence = %{
      ...
      paper_type: :study,
      summary:
        "The original 1998 Lancet paper by Andrew Wakefield that initiated the MMR-autism scare was completely retracted in February 2010 due to ethical violations and scientific misrepresentation [Paper 4]."
    }

    paper = %{
      "title" => "The MMR vaccine and autism: Sensation, refutation, retraction, and fraud",
      "abstract" =>
        "The original 1998 paper was retracted after ethical violations, undisclosed conflicts, and scientific misrepresentation were established.",
      "publicationTypes" => []
    }
  ...
  test "evidence_store_for keeps discourse-only misinformation fragments in belief" do
    context = %{
      normalized_topic: "vaccines cause autism",
      evidence_profile: %{
        kind: :observational,
    ...
    evidence = %{
      ...
      paper_type: :study,
      summary:
        "Research on misinformation dissemination demonstrates that claims like \"Link Found Between Vaccines and Autism\" can be artificially generated by language models and that humans find such AI-generated disinformation more trustworthy than human-written disinformation [Paper 5]. This illustrates how vaccine-autism misinformation persists and spreads through media ecosystems despite lacking any scientific foundation."
    }

    paper = %{
      "title" => "Defending Against Neural Fake News",
      "abstract" =>
        "This paper studies whether language models can generate convincing fake news articles with misleading health headlines.",
      "publicationTypes" => []
    }

    assert Investigate.grounding_role_for(evidence, context, paper) == :contextual
    assert Investigate.verification_claim_text(evidence.summary) =~ "claims like"
  ...
  test "evidence_store_for keeps direct epidemiology evidence grounded in observational mode" do
    context = %{
      normalized_topic: "vaccines cause autism",
      evidence_profile: %{
        kind: :observational,
    ...
    evidence = %{
      ...
      paper_type: :study,
      summary:
        "Epidemiological studies have found no association between MMR vaccination and autism even among the highest-risk children—those whose older siblings already had autism [Paper 3]."
    }

    paper = %{
      "title" => "The MMR Vaccine and Autism",
      "abstract" =>
        "Several epidemiologic studies have not found an association between MMR vaccination and autism, including among children at elevated familial risk.",
      "publicationTypes" => []
    }
  ...
  test "evidence_store_for keeps outcome-only prevalence explanations in belief for observational claims" do
    context = %{
      ...
      evidence_profile: %{
        kind: :observational,
        subject_terms: ["vaccination", "autism"]
      }
    }
    ...
    evidence = %{
      ...
      paper_type: :study,
      summary:
        "Research on autism prevalence increases has found that \"changes in reporting practices can account for most (60%) of the increase in the observed prevalence of ASDs in children born from 1980 through 1991 in Denmark\" [Paper 7]."
    }

    paper = %{
      "title" => "Explaining the Increase in the Prevalence of Autism Spectrum Disorders",
      "abstract" =>
        "This study found that changes in reporting practices can account for most of the observed increase in autism prevalence.",
      "publicationTypes" => []
    }
