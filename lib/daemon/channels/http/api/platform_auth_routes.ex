defmodule Daemon.Channels.HTTP.API.PlatformAuthRoutes do
  @moduledoc """
  ...
  alias Daemon.Platform.Auth, as: PlatformAuth
  ...
  defp platform_enabled?, do: Application.get_env(:daemon, :platform_enabled, false)
