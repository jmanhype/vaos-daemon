defmodule Daemon.CLI.Doctor do
  @moduledoc """
  Health check for the `daemon doctor` CLI subcommand.
  ...
  defp check_tui do
    ...
    rust_tui = if priv_dir, do: Path.join([priv_dir, "rust", "tui", "target", "release", "daemon-tui"]), else: nil
  ...
  defp check_working_directory do
    ...
    cond do
      ...
      true ->
        {:fail, "Working directory", "~/.daemon/workspace not found"}
    end
  end
