defmodule Daemon.Agent.Strategy do
  @moduledoc """
  ...
  @strategies [
    Daemon.Agent.Strategies.MCTS,
    Daemon.Agent.Strategies.Reflection,
    Daemon.Agent.Strategies.TreeOfThoughts,
    Daemon.Agent.Strategies.ChainOfThought,
    Daemon.Agent.Strategies.ReAct
  ]
  ...
  ## Examples
      ...
      iex> {:ok, mod} = Daemon.Agent.Strategy.resolve_by_name(:react)
      iex> mod.name()
      :react
  """
