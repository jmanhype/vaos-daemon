defmodule Daemon.PromptLoader do
  ...
  def load do
    ...
    bundled_dir = Path.join(:code.priv_dir(:daemon), "prompts")
  ...
  defp load_command_prompts do
    ...
    user_dir = Path.expand("~/.daemon/commands")
