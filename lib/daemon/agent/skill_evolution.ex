defmodule Daemon.Agent.SkillEvolution do
  @moduledoc """
  ...
  Evolved skills are stored under ~/.daemon/skills/evolved/<name>/SKILL.md
  ...
  @metrics_table :daemon_skill_metrics
  ...
  @doc "List all skill names evolved under ~/.daemon/skills/evolved/"
