defmodule Daemon.Agent.Orchestrator.SwarmWorker do
  @moduledoc """
  ...
  Lifecycle:
    1. Started by SwarmMode under DynamicSupervisor
  ...
  them; instead SwarmMode handles failure via the return value from
  `assign/3`.
  """
  ...
  alias Daemon.Agent.Orchestrator.Mailbox
