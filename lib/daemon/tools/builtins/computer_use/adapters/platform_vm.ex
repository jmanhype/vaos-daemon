defmodule Daemon.Tools.Builtins.ComputerUse.Adapters.PlatformVM do
  @moduledoc """
  ...
  Local files land in `~/.daemon/screenshots/`.
  ...
  defp get_config do
    Application.get_env(:daemon, :computer_use_vm, [])
  end
