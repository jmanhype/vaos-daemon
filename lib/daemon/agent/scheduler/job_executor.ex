defmodule Daemon.Agent.Scheduler.JobExecutor do
  @moduledoc """
  ...
  @max_output_bytes Daemon.Security.ShellPolicy.max_output_bytes()
  ...
  def run_shell_command(command) when is_binary(command) do
    ...
    if command == "" do
      ...
      case Daemon.Security.ShellPolicy.validate(command) do
        :ok ->
          task =
            Task.async(fn ->
