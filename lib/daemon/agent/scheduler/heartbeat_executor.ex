defmodule Daemon.Agent.Scheduler.HeartbeatExecutor do
  @moduledoc """
  ...
  alias Daemon.Agent.Scheduler.JobExecutor
  ...
  defp check_budget do
    if Code.ensure_loaded?(Daemon.Agent.Treasury) and
       function_exported?(Daemon.Agent.Treasury, :get_balance, 0) do
      case Daemon.Agent.Treasury.get_balance() do
