defmodule Daemon.Agent.Learning do
  @moduledoc """
  Learning engine — tracks patterns, solutions, and corrections in ETS.

  Uses `:daemon_learning_patterns` for hot reads. Persists to disk every 50
  observations at `~/.daemon/learning/patterns.json` and `solutions.json`.
  """
