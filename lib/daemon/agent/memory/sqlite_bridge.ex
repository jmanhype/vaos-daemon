defmodule Daemon.Agent.Memory.SQLiteBridge do
  @moduledoc """
  Secondary store bridge from MiosaMemory to OSA's Ecto/SQLite message store.

  Implements the secondary_store contract expected by MiosaMemory.Store:
