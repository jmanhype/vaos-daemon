defmodule Daemon.OS.Scanner do
  @moduledoc """
  ...
  1. Paths listed in `~/.daemon/config.json` under `"os.scan_paths"`
  2. `~/.daemon/templates/` (dedicated template directory)
