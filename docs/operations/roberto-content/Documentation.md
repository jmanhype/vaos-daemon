...
4. Start from the three blocker traces above, not from the old ledger failure.
5. Decide whether the next narrow move is provider/fallback stabilization or a deterministic live-validation harness for recurring refs `2/7/8`.
