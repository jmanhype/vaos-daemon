defmodule Daemon.Agent.CostTracker do
  @moduledoc """
  ...
  def handle_call(:get_summary, _from, state) do
    ...
    daily_limit = parse_float_env("DAEMON_TREASURY_DAILY_LIMIT", 250.0)
    monthly_limit = parse_float_env("DAEMON_TREASURY_MONTHLY_LIMIT", 2500.0)
