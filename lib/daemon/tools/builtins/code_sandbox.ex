defmodule Daemon.Tools.Builtins.CodeSandbox do
  @moduledoc """
  ...
  @impl true
  def available? do
    docker_available?() or Application.get_env(:daemon, :code_sandbox_fallback_enabled, false)
  end
  ...
  defp execute_fallback("elixir", code, timeout, _stdin) do
    if not Application.get_env(:daemon, :code_sandbox_fallback_enabled, false) do
  ...
  defp execute_fallback("python", code, timeout, stdin) do
    if Application.get_env(:daemon, :code_sandbox_fallback_enabled, false) do
