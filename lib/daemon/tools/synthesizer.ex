defmodule Daemon.Tools.Synthesizer do
  @moduledoc """
  ...
  a module implementing MiosaTools.Behaviour, writes it to ~/.daemon/tools/<name>.ex,
  ...
  Generated modules live under `Daemon.Tools.Generated.<CamelName>`.
  """
  use GenServer
  require Logger
  ...
  @doc "List names of synthesized tools (from ~/.daemon/tools/)."
  ...
  defp do_synthesize(name, spec) do
    ...
    with :ok <- validate_spec(description, params, body),
         ...
         module_name = "Daemon.Tools.Generated.#{camel_name}",
  ...
  defp generate_source(name, description, params, body, camel_name) do
    ...
    """
    defmodule Daemon.Tools.Generated.#{camel_name} do
