defmodule Daemon.Utils do
  @moduledoc """
  Shared utility functions used across the Daemon codebase.

  Sub-modules:
  - `Daemon.Utils.Tokens` — heuristic token estimation
  - `Daemon.Utils.Text`   — string manipulation helpers
  - `Daemon.Utils.ID`     — unique ID generation
  """
end

defmodule Daemon.Utils.Tokens do
  @moduledoc """
...
defmodule Daemon.Utils.Text do
  @moduledoc """
...
defmodule Daemon.Utils.ID do
  ...
  Generates a random 16-character hex ID, optionally prefixed.
      ...
      iex> Daemon.Utils.ID.generate()
      "a3f2c1d4e5b6a7c8"

      iex> Daemon.Utils.ID.generate("task")
