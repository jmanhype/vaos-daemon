defmodule Daemon.Channels.Manager do
  @moduledoc """
  ...
  ## Usage
      ...
      Daemon.Channels.Manager.list_channels()
      #=> [%{name: :telegram, connected: true, module: Daemon.Channels.Telegram}, ...]

      # Send a message via a specific channel
      Daemon.Channels.Manager.send_to_channel(:telegram, "123456789", "Hello!")
  ...
  @channel_modules [
    ...
    Daemon.Channels.WhatsApp,
    Daemon.Channels.Signal,
    Daemon.Channels.Matrix,
    Daemon.Channels.Email,
    Daemon.Channels.QQ,
    Daemon.Channels.DingTalk,
    Daemon.Channels.Feishu
  ]
  ...
  defp channel_configured?(channel) do
    ...
    if File.exists?(config_path) do
      ...
      case channel do
        :telegram -> Application.get_env(:daemon, :telegram_token) != nil
        :discord -> Application.get_env(:daemon, :discord_token) != nil
        :slack -> Application.get_env(:daemon, :slack_bot_token) != nil
        :whatsapp -> Application.get_env(:daemon, :whatsapp_token) != nil
        :signal -> Application.get_env(:daemon, :signal_phone) != nil
        :matrix -> Application.get_env(:daemon, :matrix_homeserver) != nil
        :email -> Application.get_env(:daemon, :email_smtp_host) != nil
        :qq -> Application.get_env(:daemon, :qq_appid) != nil
        :dingtalk -> Application.get_env(:daemon, :dingtalk_app_key) != nil
        :feishu -> Application.get_env(:daemon, :feishu_app_id) != nil
        _ -> false
      end
    end
  end
