defmodule Daemon.Agent.Compactor do
  @moduledoc """
  ...
  defp tier1_threshold, do: Application.get_env(:daemon, :compaction_warn, 0.85)

  defp tier2_threshold,
    do: Application.get_env(:daemon, :compaction_aggressive, 0.85)

  defp tier3_threshold,
    do: Application.get_env(:daemon, :compaction_emergency, 0.95)
